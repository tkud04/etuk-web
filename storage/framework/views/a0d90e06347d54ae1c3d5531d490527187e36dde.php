...
$n = isset($admin) && $admin ? "admin" : $u->fname;
...
<a style="padding: 30px 20px; margin-right: 5px;color: #fff!important; display: inline-block; text-decoration: none; background: red;" href="<?php echo e($approveURL); ?>">YES</a>
<a style="padding: 30px 20px; color: #fff!important; display: inline-block; text-decoration: none; background: green;" href="<?php echo e($declineURL); ?>">NO</a>
