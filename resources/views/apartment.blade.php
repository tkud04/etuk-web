														...
														<div class="guests">
															<div class="advance-bboking">
																...
																<div class="guests-box">
																	  ...
																	  <input type="text" id="guestNo" name="guests" value="2" max="{{$terms['max_children']}}"/>
													...
													<div class="form-group">
														<div class="guests">
															<div class="advance-bboking">
																...
																<div class="guest-type">
																	<h5>Child</h5>
																	<span>{{$terms['max_children']}} max.</span>
																</div>
																
																<div class="guests-box">
																	<button class="counter-btn" type="button" id="kcnt-down"><i class="ti-minus"></i></button>
																	<input type="text" id="kidsNo" name="kids" value="0" max="{{$terms['max_children']}}"/>
							...
							<div class="page-sidebar" id="apartment-hostchat">
								...
								<div class="agent-widget">
								   ...
								   <input type="hidden" id="apt-gsb" value="{{$uid}}"/>
									...
									<div class="form-group">
										<label>Message</label>
										<textarea class="form-control" id="apt-chat-msg" placeholder="Send a message to {{$host['fname']}}..."></textarea>
									</div>
