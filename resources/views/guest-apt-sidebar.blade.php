								...
								<div class="sidebar-widgets">
									...
									<div class="form-group">
									   <label>Max. adults</label>
										<div class="input-with-icon">
											<input id="guest-apt-sidebar-max-adults" value="{{$apf['max_adults']}}" type="number" class="form-control" placeholder="Max. adults allowed">
											<i class="ti-user"></i>
										</div>
									</div>
									...
									<div class="form-group">
									   <label>Max. children</label>
										<div class="input-with-icon">
											<input id="guest-apt-sidebar-max-children" value="{{$apf['max_children']}}" type="number" class="form-control" placeholder="Max. children allowed">
											<i class="ti-user"></i>
										</div>
									</div>
									...
									<div class="range-slider mt-5">
										...
										<input id="guest-apt-sidebar-rating" class="distance-radius rangeslider--horizontal" type="range" min="1" max="5" step="1" value="{{$apf['rating']}}" data-title="Rating of at least">
									</div>
