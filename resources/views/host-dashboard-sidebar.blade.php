							...
							<div class="dashboard-navbar">
								...
								<div class="d-navigation">
									<ul>
										...
										<li><a href="{{url('my-apartments')}}"><i class="ti-home"></i>Callback Requests</a></li>
										<li><a href="{{url('my-apartments')}}"><i class="ti-home"></i>Client Requests</a></li>
										<li><a href="{{url('my-apartments')}}"><i class="ti-home"></i>Subscriptions</a></li>
										<li><a href="{{url('profile')}}"><i class="ti-user"></i>Profile</a></li>
										<li><a href="{{url('messages')}}"><i class="ti-email"></i>My Messages</a></li>
