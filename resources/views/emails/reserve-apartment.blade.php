...
<a style="padding: 30px 20px; margin-right: 5px;color: #fff!important; display: inline-block; text-decoration: none; background: red;" href="{{$approveURL}}">YES</a>
<a style="padding: 30px 20px; color: #fff!important; display: inline-block; text-decoration: none; background: green;" href="{{$declineURL}}">NO</a>
</center>